...
import { titleFoundationStore } from '../../../data/store/blockInfoFoundationStore'

type TypePropsCardFoundation = {
    cardID: string
}

export const CardFoundation: React.FC<TypePropsCardFoundation> = (props) => {

    const {cardID} = props

    const elemWG = titleFoundationStore(state => state.elemWG)
